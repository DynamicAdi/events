...
function BlogCard() {
  return (
    <div className="w-72 h-5/6 relative hover:scale-105 hover:-translate-y-8 group transition-all cursor-pointer bg-transparent rounded-3xl flex flex-col justify-start items-start p-2">
    ...
    <div className="h-1/2 w-full py-2">
      ...
      <div className="w-full flex justify-start items-center mt-4 text-gray-400">

          ...
          <div className="sm:w-10/12 w-[95%] sm:h-full h-auto bg-primary rounded-2xl p-4 text-white relative">
            ...
            <form className="mt-6 sm:inline-block flex flex-col justify-start items-start">
              ...
              <input
                ...
                type="text"
              />
              <textarea required placeholder="Tell us about your queries in details" className="resize-none w-full h-[200px] bg-transparent outline-none pb-1 placeholder:text-white/40 placeholder:font-light placeholder:font-mon p-2 border-b-2 border-solid border-white mt-8"></textarea>
              <button className="sm:absolute relative sm:bottom-4 mt-7 sm:mt-0 bg-white text-primary sm:w-[95%] w-full py-3 sm:left-5 rounded-lg text-3xl font-medium hover:scale-95 transition-transform font-mon text-center">Let's Talk!</button>
            </form>
          </div>
        </div>
      </div>

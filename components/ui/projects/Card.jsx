...
function PastProjectCards({title, description, png}) {
  return (
    ...
    <div className="h-1/2 w-full py-2">
      <h1 className="font-pop text-2xl text-ellipsis font-semibold text-white">
        {title}
      </h1>
      <p className="leading-tight text-sm mt-2 text-justify text-white font-light">
        {description}
      </p>

      <button className="absolute bottom-2 flex justify-center items-center right-4 text-white gap-1">Explore <GoArrowUpRight className='rotate-45'/></button>
    </div>
  </div>
  )
}
